...
const translations = {
  zh: {
    ...
    heroCopy: '多图上传、拖拽排序、旋转校正和本地导出都在浏览器里完成，Papery 会帮你把散落的图片整理成清爽文档。',
    featureUpload: '多图上传',
    featureMerge: '一键合并',
    featureSort: '智能排序',
    featureFast: '快速生成',
    uploadPanelKicker: '收集图片',
    uploadPanelTitle: '把图片交给 Papery',
    previewKicker: 'PDF 预览',
    previewTitle: '拖拽缩略图调整页面顺序',
    exportKicker: '导出设置',
    exportTitle: '生成前检查格式',
  ...
  en: {
    ...
    heroCopy: 'Upload many images, reorder pages, rotate scans, and export locally in the browser. Papery keeps the loose images moving into one tidy document.',
    featureUpload: 'Multi-upload',
    featureMerge: 'One merge',
    featureSort: 'Smart order',
    featureFast: 'Fast export',
    uploadPanelKicker: 'Collect images',
    uploadPanelTitle: 'Hand them to Papery',
    previewKicker: 'PDF preview',
    previewTitle: 'Drag thumbnails to set page order',
